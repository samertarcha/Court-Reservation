...
if(isset($_POST['updRes'])){
    ...
    if ($checkReservationDayA != null) {
        ...
        ';
            ...
            mysqli_query($conn, "UPDATE `reservations` SET `reservation_date`='$resDay',`reservation_start`='$startTime',`reservation_end`='$endTime' WHERE res_id = '$id' and user_id_fk = $user_id_fk;");
            ...
            Swal.fire({
                ...
                window.location = 'myreservations.php';
            });
